...
def analyze_with_gemini(text):
    text=model.generate_content(f'Translate the given doctor-patient conversation in english if it is not in english:{text} and fill in some missing words/grammar if needed.')
    prompt = f'''
