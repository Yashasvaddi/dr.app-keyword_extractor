...
def analyze_with_gemini(text):
    text1=model.generate_content(f'Translate the given doctor-patient conversation to english:{text} and fill in some missing words/grammar if needed. Summarize the content upto 50% but dont miss any important detail mentioned in the convo. Return only the summary')
    prompt = f'''
